...
# in train_t5.py, right after imports
import t5_utils, inspect
print("USING T5_UTILS FROM:", t5_utils.__file__)
...
def test_inference(args, model, test_loader, model_sql_path, model_record_path):
    ...
    # Save queries and compute records
    save_queries_and_records(generated_queries, model_sql_path, model_record_path)
    print(f"Saved {len(generated_queries)} test predictions to {model_sql_path}")
