...
def load_model_from_checkpoint(args, best):
    ...
    ckpt_dir = os.path.join('checkpoints', f'{model_type}_experiments', args.experiment_name)
    ...
    if os.path.exists(path):
        ...
        print(f"No checkpoint found at {path}; using fresh weights.")
...
def initialize_optimizer(args, model):
    ...
    if model is not None:
        print(f"DEBUG: model has named_children = {hasattr(model, 'named_children')}")
